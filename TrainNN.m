...
net.divideParam.trainInd= [1:105 150:255]; % training data indices 
% net.divideParam.trainInd= 1:105;
net.divideParam.valInd= [106:126 256:276]; % validation data indices 
net.divideParam.testInd=[127:150 277:295];  % testing data indices 
% Train the Network
